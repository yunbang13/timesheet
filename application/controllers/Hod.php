...
class HOD extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view("hod/dashboard_view");
		// main
	...
	public function manage_sub(){
		...
		$data["page"] = "Team Members";
		$data["action"] = "";

		$data["info_organization"] = $this->nama_organisasi;
		$data["employee_list"] = $this->employee_model->allEmployee($_SESSION['role_user']);
		...
		// top bar
		$this->load->view("mainpage/topbar_view");
		$this->load->view("hod/manage_sub_view");
		// main
		$this->load->view("mainpage/canvas_main_end");
		$this->load->view("mainpage/canvas_side_end");
		$this->load->view("mainpage/footer_view");
	...
	public function manage_attendance(){
		...
		// top bar
		$this->load->view("mainpage/topbar_view");
		$this->load->view("hod/manage_attendance_view");
		// main
		$this->load->view("mainpage/canvas_main_end");
		$this->load->view("mainpage/canvas_side_end");
		$this->load->view("mainpage/footer_view");
